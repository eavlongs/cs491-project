...
import com.movie.theater.constants.ResponseMessage;
...
public class ResponseHelper {
	...
	public static ResponseEntity<Map<String, Object>> buildBadRequestResponse(Map<String, Object> error, String message) {
		String responseMessage = message != null ? message : ResponseMessage.BAD_REQUEST;
		return buildErrorResponse(error, responseMessage, HttpStatus.BAD_REQUEST);
	}
	
	public static ResponseEntity<Map<String, Object>> buildBadRequestResponse() {
		return buildBadRequestResponse(null, null);
	}
